export default function Footer() {
  return (
    <footer className="footer relative items-center p-4 m-3 mt-10 w-auto rounded-lg text-neutral-content bg-gradient-to-r from-white  to-purple-400 -bottom-2 z-50">
